...
var es6ArrowCompile = require('es6-arrow-function').compile;
...
exports.ES6ArrowPreprocessor = ES6ArrowPreprocessor
__extends(ES6ArrowPreprocessor, Preprocessor)
function ES6ArrowPreprocessor () {
  ES6ArrowPreprocessor.__super__.constructor.apply(this, arguments)
}

ES6ArrowPreprocessor.prototype.extensions = ['js']
ES6ArrowPreprocessor.prototype.targetExtension = 'js'

ES6ArrowPreprocessor.prototype.process = function (srcFilePath, destFilePath, info, callback) {
  var code = fs.readFileSync(srcFilePath).toString()
  var output
  try {
    output = es6ArrowCompile(code)
  } catch (err) {
    /* jshint camelcase: false */
    // err.line = err.location && err.location.first_line
    // err.column = err.location && err.location.first_column
